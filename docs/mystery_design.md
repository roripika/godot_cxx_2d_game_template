## 1. 登場人物設定 (Main Characters)

| 役割 | 名前 (仮) | 性格・特徴 |
|---|---|---|
| 主人公 (探偵) | **レン (Ren)** | クールで鋭い洞察力を持つが、時折抜けている面もある。過去に未解決の怪事件を追っている。 |
| ボス | **ケン (Ken)** | 探偵事務所の所長。厳格だが部下思い。業界に顔が広く、情報収集の要。 |
| 助手 | **ユイ (Yui)** | 明るく元気なサポート役。ガジェットや証拠品の整理が得意で、現場のムードメーカー。 |

## 2. 倉庫街の人物 (NPCs)

| 役割 | 名前 (仮) | 性格・特徴 |
|---|---|---|
| 倉庫の管理者 | **田中 (Tanaka)** | 中年の几帳面な男性。神経質で、管理外の事象（幽霊など）を極端に嫌う。何かを隠している。 |
| 倉庫の作業者 | **佐藤 (Sato)** | 若い労働者。仕事には不真面目だが、倉庫内の「変な音」や「妙な影」については詳しい。 |
| 搬入業者 | **鈴木 (Suzuki)** | 常に時間に追われている。夜間に倉庫付近で不審な人物を目撃したらしい。 |
| 新聞配達の男の子 | **ケンタ (Kenta)** | 近所の少年。街の隅々に詳しく、鋭い観察眼を持つ。重要な手がかりを偶然見つけている。 |

## 3. シナリオ構成案 (Expanded Plot)

1. **プロローグ**: 助手のユイから、近隣の倉庫で発生している「荷物消失事件」の報告を受けるところから始まる。
2. **調査パート**: 倉庫に赴き、管理者（田中）や作業員（佐藤）に聞き込みを行う。
3. **転換点**: 搬入業者（鈴木）や新聞配達員（ケンタ）からの証言により、単なる盗難ではない可能性が浮上する。
4. **推理パート**: 集めた証拠を元に、ボスのケンと状況を整理。
5. **対決パート**: 全ての嘘を暴き、犯人（あるいは怪異の正体）を突き止める。
