...
1. `P4-01 generator_commonization_candidates`
2. `P4-02 human_gate_decision_matrix`
3. `P4-03 docs_readme_phase4_navigation`
4. `P4-04 generator_regression_expansion_plan`
