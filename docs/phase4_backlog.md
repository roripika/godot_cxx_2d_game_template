...
1. `P4-05 spec_input_normalization_note`
2. `P4-06 generated_lifecycle_check_sync`
3. `P4-07 generator_test_case_backlog`
4. `P4-08 phase4_midpoint_review`（P1 実績が揃ってから）
